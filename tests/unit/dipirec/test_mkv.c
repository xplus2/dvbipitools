...
#include "dipirec/mux/mkv.h"
#include "lib/demux/crc32.h"
#include "lib/mux/psi_build.h"

/* Only audio path covered (video needs H.264/HEVC SPS bitstreams).
   mkv.c discovers PAT/PMT/SDT itself via mkv_feed, same as ts_filter.c. */
...
/* feeds PAT (program 101 -> PMT pid 0x100), a 1-audio-ES PMT (AAC, pid
   0x101), and an SDT for program 101 (so mkv doesn't wait ~2s real time for one) */
