...
#ifndef DIPITVHEAD_CONFIG_PRIV_H
#define DIPITVHEAD_CONFIG_PRIV_H
...
int tvh_apply_cas_ecmg_version(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_super_id(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_ecm_id(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_ecm_pid(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_emmg_port(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_emmg_max_conns(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_emmg_version(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_emmg_reverse(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_emm_pid(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_resilience(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_cwenc_algo(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_cwenc_aes_mode(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_cwenc_fixed_key(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_cwenc_key_list_a(void *c, const char *v, char *e, size_t n);
int tvh_apply_cas_cwenc_key_list_b(void *c, const char *v, char *e, size_t n);
