...
/* video_ok: mkv vs mka. pmt_pids/n_pids: 0/NULL = single auto-lock psi_t (unchanged).
   >0: N pinned programs (-p all), tracks from all, TrackName per track once n_pids>1. */
