...
int main(int argc, char **argv) {
  ...
  log_line_ansi("\e[1mi:\e[0m\e[0;37m%s\e[0m \e[1mm:\e[0m\e[0;37m%s\e[0m \e[1mrtp:\e[0m\e[0;37m%s\e[0m", cfg.input_uri, mcast, cfg.rtp ? "yes" : "no");
  signals_install();
  return radiohead_run(&cfg);
}
