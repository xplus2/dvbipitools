...
/* station entry. tsid/onid/sid are DVB triplet (transport_stream_id, original_network_id, service_id).
   family/group/port/rtp are same address parsed into uri, needed separately for OUT_XML */
